...
if selection== "Business Snapshot":
    ...
    # New vs Existing User Revenue Analysis
        ...
        sns.relplot(x="InvoiceMonth", y="Revenue", hue="UserType", data=df_new_revenue, kind="line", height=15,
                aspect=20 / 10)
...
<div class="container">
Made by <a class="white-text text-lighten-3" href="https://africadataschool.com/">Thando </a><br/>
